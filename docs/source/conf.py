...
# -*- coding: utf-8 -*-
#
# episcanpy documentation build configuration file, created by
...
project = 'episcanpy'
copyright = '2019, Anna Danese, Maria Richter, Maria Colome-Tatche'
author = 'Anna Danese, Maria Richter, Maria Colome-Tatche'
